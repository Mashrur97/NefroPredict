...
const About = () => {
  return (
    <section className="py-16 bg-black text-white min-h-screen pt-50">
      <div className="max-w-6xl mx-auto px-4 text-center">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div className="bg-blue-800/30 border border-blue-500/30 rounded-xl p-6 shadow-md hover:shadow-blue-500/20 transition duration-300">
            ...
            {/* <p className="text-blue-300 text-sm mb-2">Data Scientist</p> */}
          ...
          <div className="bg-blue-800/30 border border-blue-500/30 rounded-xl p-6 shadow-md hover:shadow-blue-500/20 transition duration-300">
            ...
            {/* <p className="text-blue-300 text-sm mb-2">Frontend Developer</p> */}
            <p className="text-white/80 text-sm">
          ...
          <div className="bg-blue-800/30 border border-blue-500/30 rounded-xl p-6 shadow-md hover:shadow-blue-500/20 transition duration-300">
            ...
            {/* <p className="text-blue-300 text-sm mb-2">ML Engineer</p> */}
            <p className="text-white/80 text-sm">
