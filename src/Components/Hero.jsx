    ...
    >
      ...
      <div className="relative z-10 flex items-center justify-start w-full h-full px-8">
        <div className="max-w-md text-white">
          ...
          <DecryptedText text="NefroPredict is an AI-powered early detection tool for Chronic Kidney Disease. Using machine learning models trained on real clinical data, it helps identify CKD risk factors quickly and intuitively before it’s too late." />
          <br />
          <br />
          <Link to="/hows">
