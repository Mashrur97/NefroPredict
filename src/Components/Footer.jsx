...
const Footer = () => {
    return (
<footer className="footer footer-horizontal footer-center -base-content rounded p-10 bg-black">
      <NavLink to="/">
      <div className="flex gap-2 items-center text-white">
        <img src="computer.png" alt="Logo" className="h-8 w-auto" />
        <p className="font-bold text-2xl">Nefro<span className='text-blue-400'>Predict</span> </p>
      </div>
    </NavLink>
